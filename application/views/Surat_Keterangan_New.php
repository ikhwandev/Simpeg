...
<table width="670" border="0" cellspacing="2" cellpadding="2" align="center">
  <tr> 
    <td> 
      <div align="center">
        <b class="kop-surat">KANTOR KECAMATAN TIKUNG LAMONGAN</b><br>
         Jl. Raya Mantup No.29, Bakalanpule, Tikung, Kabupaten Lamongan
      </div>
  ...
  <tr>
    <td style="text-align: right;">Lamongan, <?=date("d M Y");?></td>
  </tr>
  <tr> 
    <td>&nbsp;<br></td>
  </tr>
    ...
    <div align="left">
      ...
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr> 
          ...
          <td width="70%">: <?=$type_id;?>/0<?=$id;?>/SEKCAM-Sket/<?=date('Y');?></td>
        </tr>
        <tr> 
  ...
  <tr> 
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="45%">SEKCAM<br><font class="eng">SEKCAM</font></td>
